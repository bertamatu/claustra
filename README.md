...
claustra catches all three classes - and seventeen more - before they reach production. **Real numbers from the official Next.js Learn tutorial** (`vercel/next-learn`, `dashboard/final-example`):
